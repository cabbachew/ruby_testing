...
describe BinaryGame do
  ...
  describe '#verify_input' do
    ...
    context 'when given a valid input as argument' do
      it 'returns valid input' do
        ...
        expect(verified_input).to eq(97)
      end
    end
  ...
  describe '#maximum_guesses' do
    ...
    context 'when game minimum and maximum is 100 and 600' do
      subject(:game_max600) { described_class.new(100, 600) }

      it 'returns 9' do
        max = game_max600.maximum_guesses
        expect(max).to eq(9)
      end
    end
  end
  ...
  describe '#display_turn_order' do
    ...
    subject(:game_display) { described_class.new(1, 100) }
    let(:search_display) { instance_double(BinarySearch) }
